...
window=Tk()
window.title("Caculator program")
...
subtract=Button(frame,text='-',width=9,height=4,font=35,command=lambda:button_press('-'))
subtract.grid(row=1,column=3)

multiply=Button(frame,text='*',width=9,height=4,font=35,command=lambda:button_press('*'))
multiply.grid(row=2,column=3)

division=Button(frame,text='/',width=9,height=4,font=35,command=lambda:button_press('/'))
